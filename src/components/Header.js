      ...
      <Link to="/">
        <div className="d-flex">
          ...
          <div className="headerInfo">
            <h3 className="header_react">React Headphones </h3>
            <p>Магазин лучших наушников</p>
          </div>
        </div>
      </Link>

      <ul className="header_right d-flex cu-p">
        <li className="icon_cart" onClick={props.onClickCart}>
